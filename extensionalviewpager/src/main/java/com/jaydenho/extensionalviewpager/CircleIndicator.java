...
public class CircleIndicator extends LinearLayout {
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                0, 0, R.drawable.white_radius, R.drawable.white_radius);
    }
...
//        mAnimatorResId = (mAnimatorResId == 0) ? R.anim.scale_with_alpha : mAnimatorResId;
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        mPagerAdapter = mViewpager != null ? mViewpager.getAdapter() : null;
    ...
    private int getPagerAdapterCount() {
        return isInfiniteLoop() ? ((InfiniteLoopPagerAdapter) mPagerAdapter).getRealCount() : mPagerAdapter.getCount();
    }

    private boolean isInfiniteLoop() {
        return mPagerAdapter instanceof InfiniteLoopPagerAdapter;
    }
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            if (isInfiniteLoop()) {
                position = ((InfiniteLoopPagerAdapter) mPagerAdapter).getRealPosition(position);
            }
            if (mViewpager.getAdapter() == null || getPagerAdapterCount() <= 0) {
                return;
            }
    ...
    private DataSetObserver mInternalDataSetObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            int newCount = getPagerAdapterCount();
    ...
    private void createIndicators() {
        removeAllViews();
        int count = getPagerAdapterCount();
        if (count <= 0) {
            return;
        }
